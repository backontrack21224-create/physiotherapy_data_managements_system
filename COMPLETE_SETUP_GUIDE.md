# 📘 Complete Setup Guide for Back on Track with Google Sheets Apps Script

## 🎯 Overview
This guide will help you connect your Back on Track application to Google Sheets using Apps Script. This is simpler than using the Google Sheets API and doesn't require service account credentials.
...
3. Name it: **"Back on Track Assessments"**
...
8. Name your project: **"Back on Track API"**
...
4. Configure the deployment:
   - **Description**: `Back on Track API v1`
...
6. **IMPORTANT - Authorization Step** (You'll see a warning - this is NORMAL!):
   ...
   - Click **Go to Back on Track API (unsafe)** (it's not actually unsafe - it's YOUR script!)
...
- **It's completely safe** to click "Advanced" → "Go to Back on Track API (unsafe)"
...
Your Back on Track application is now connected to Google Sheets!
...
**Created for Back on Track** | Last updated: December 2025
