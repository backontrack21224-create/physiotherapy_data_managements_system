...
2. **Click "Go to Back on Track API (unsafe)"**
...
│  [Advanced] ← CLICK HERE             │
│                                      │
│  ▼ Go to Back on Track API (unsafe)   │
└─────────────────────────────────────┘
```

**Step 3: Click "Go to Back on Track API (unsafe)"**
```
┌─────────────────────────────────────┐
│  Back on Track API wants to access    │
│  your Google Account                 │
│                                      │
│  This will allow Back on Track API to: │
...
- ✅ Click "Advanced" → "Go to Back on Track API (unsafe)" → "Allow"
